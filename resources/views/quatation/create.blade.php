...
<div class="container" style="padding-top:20px;">
  <div class="col-xs-10 col-md-10">
    ...
    <div class="col-xs-10 col-md-10">
        <form action="{{ action('QuatationController@store') }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
        ...
        @endif
          <div class="box-body ">
            ...
            <div  style="text-align:center;padding-top:20px;" >
                <a href="{{url('/')}}/quatation/listdata/<?php echo $value; ?>" class="btn btn-primary">Cancel</a>
