    ...
    <div class="col-md-2">
      ...
      <div class="container" style="padding-top:30px;">
        ...
        <div class="row" style="padding-top:50px;">
          ...
          <form method="POST" action = "{{url('/')}}/requirement/<?php echo $value->id; ?>" enctype="multipart/form-data">
              {{ csrf_field() }}
            {{ method_field('PUT') }}
                ...
                <div class="box-body ">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-xs-9">
                          <a href="{{url('/')}}/requirement/listdata/<?php echo $value->project_id; ?>" class="btn btn-primary">Cancel</a>
