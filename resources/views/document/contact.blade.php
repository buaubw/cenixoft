  ...
  <div class="container" style="padding-top:50px;">
    <div class="col-md-8">
      <center><a  href="{{url('document/requirement')}}" class="btn btn-warning" style=" margin-left: 20px">Requirement</a>
        ...
        <a href="{{url('document/inboxcontact')}}"  class="btn btn-warning " style=" margin-top: 20px" style="#ff0000">Inbox</a>
    </div>
                ...
                <table class="table table-hover">
                  <tr>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><a  href="{{url('document/editcontact')}}"><i class="fa fa-edit"></i> </a></td>
